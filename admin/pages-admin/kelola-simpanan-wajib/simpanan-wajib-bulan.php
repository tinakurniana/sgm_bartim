									...
									<tr>
										...
										<td class="center">
											<div class="action-buttons">
												<a data-rel="tooltip" data-placement="top" title="Data Simpanan Wajib" class="blue tooltip-info" href="indexAdmin.php?p=kelola-simpanan-wajib&m=simpanan-wajib&id_tahun=<?= $id_tahun ?>&id_bulan=<?= $value['id'] ?>">
