...
$query_hasil_produksi = "SELECT SUM(pendapatan) AS total_produksi FROM pembagian_hasil WHERE pembagian_hasil.`id_bulan` = $id_bulan AND pembagian_hasil.`id_tahun` = $id_tahun";
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="POST" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-12 col-sm-5" name="total_hasil_produksi" id="total_hasil_produksi" value="Rp. <?= number_format($hasil_produksi[0]['total_produksi'], 2, ",", "."); ?>" required />
							</div>
						</div>
					</form>
					<!--PAGE CONTENT ENDS-->
					...
					<div class="modal-body">
						<div class="form-group">
							<div class="col-sm-12">
								...
								<div class="row-sm-4">
									<label class="control-label" for="total_bersih">Pendapatan Bersih</label>
									<input type="text" id="total_bersih" name="total_bersih" class="col-xs-12 col-sm-12" required />
								</div>
							</div>
						</div>
					</div>
